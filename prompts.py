...
""",
# ==========================================
# 专为 Anime 动漫大模型 (Anima) 深度优化的 Danbooru 打标样式
# ==========================================
"anima_style": """Your task is to generate pure Danbooru-style tags optimized for anime image generation models (Anima). 
Follow these rules STRICTLY:

## Output Format
- Output ONLY a single line of comma-separated tags.
- NO natural language, NO sentences, NO markdown, NO bullet points, NO line breaks.

## Quality Prefix
Always start with these quality tags:
"masterpiece, best quality, great quality, highres, absurdres, newest, "

## Tag Order (follow this exact sequence)
1. **Character count:** 1girl / 1boy / solo / 2girls / multiple girls / etc.
2. **Copyright/Series:** e.g. genshin_impact, hololive, original (if no copyright, use "original")
3. **Character names:** full character name with underscores, e.g. hatsune_miku, raiden_shogun
4. **Head & Face:** face shape, eye color, eye style (e.g. blue_eyes, gradient_eyes, slit_pupils, glasses, ahoge, animal_ears, fox_ears, cat_ears, etc.)
5. **Hair:** hair_color, hair_length, hairstyle (e.g. pink_hair, long_hair, twintails, bangs, hair_ribbon, streaked_hair)
6. **Body traits:** body type, skin tone, chest size (e.g. slim, pale_skin, medium_breasts, petite, muscular)
7. **Clothing (top to bottom):** topwear, bottomwear, dress, footwear, legwear (e.g. school_uniform, pleated_skirt, thighhighs, knee_boots, jacket, hoodie, kimono, sailor_collar)
8. **Accessories:** headwear, jewelry, props (e.g. hair_ornament, ribbon, choker, earrings, sword, wand, wings, tail)
9. **Pose & Action:** sitting, standing, leaning_forward, arms_up, holding_object, looking_at_viewer, hand_on_hip, dynamic_pose
10. **Expression:** smile, blush, open_mouth, closed_eyes, tears, angry, seductive_smile, embarrassed, neutral
11. **Composition:** upper_body, full_body, cowboy_shot, portrait, face_focus, dutch_angle, from_side, from_below, from_behind
12. **Background:** simple_background, white_background, gradient_background, street, classroom, nature, night_sky, cityscape, indoors
13. **Lighting & Color:** soft_lighting, backlighting, golden_hour, neon_lights, pastel_colors, monochrome, vivid_colors, lens_flare
14. **Effects:** depth_of_field, motion_blur, bokeh, chromatic_aberration, sparkling, wind, petals, sakura, particles, speed_lines
15. **Art Style:** anime_coloring, flat_colors, cel_shading, thick_outlines, soft_shading, watercolor_(style), sketch
16. **Rating:** safe / suggestive / questionable (choose based on image content)

## Anime-Specific Guidelines
- ALWAYS use underscores for multi-word tags (e.g., "school_uniform" not "school uniform").
- Prefer SPECIFIC anime-style descriptors: "anime_coloring", "cel_shading", "flat_colors", "thick_outlines".
- For eyes, use precise anime eye descriptors: "upturned_eyes", "downturned_eyes", "tsurime", "tareme", "gradient_eyes", "sparkling_eyes".
- For expressions, use standard anime expression tags: ">:3", "XD_face", ">_<", "uwu", "pout", "nosebleed".
- Mention skin details relevant to anime: "pale_skin", "blush", "sweat", "embarrassed", "blush_stickers".
- If the art style is distinctive (e.g., watercolor, sketch-like, thick lines, retro anime, 90s_anime), tag it.
- For NSFW/suggestive content, use proper Danbooru rating tags and content descriptors appropriately.
- Do NOT fabricate tags that are not visible in the image.
- Keep tag count between 30 and 80 depending on image complexity.

## Important
Output NOTHING but the comma-separated tag string. No explanations, no greetings, no markdown.
""",
}
...
prompts_names_only = {
    ...
    "chroma-style": False,
    "short":False,
    "anima_style":False, # 纯标签输出，不需要 Markdown 分析格式
    }
